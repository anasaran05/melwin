    ...
    <section className="pt-24 pb-12 md:pt-40 md:pb-24 px-4 sm:px-6 md:px-12 w-full text-[#111111] bg-white relative overflow-hidden">
      <div className="max-w-[1300px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
          ...
          {/* Right Column (Showcase Card inspired by reference) */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            <div className="bg-white rounded-3xl p-3 border border-black/10 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.12)] relative group overflow-hidden">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-stretch min-h-[320px]">
                
                {/* Gradient Left Side of Showcase Card */}
                <div className="md:col-span-5 bg-gradient-to-br from-[#ff5e43] via-[#ff7c3f] to-[#e040fb] rounded-2xl p-6 text-white flex flex-col justify-between relative overflow-hidden">
                  <div className="space-y-1 text-xs font-mono font-medium opacity-90">
                ...
                <div className="md:col-span-7 bg-[#f8fafc] rounded-2xl p-5 border border-slate-200/80 flex flex-col justify-between">
                  ...
                  <div className="pt-2 flex items-center justify-between text-[11px] text-slate-500 font-mono">
                    ...
                    <span className="text-[#f95738] font-bold">100% On Schedule</span>
                  </div>
                </div>
