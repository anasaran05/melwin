...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-center items-center text-[#111111] pt-20 md:pt-24 pb-8 md:pb-12 overflow-hidden">
      ...
      <div className="w-full px-6 md:px-16 flex flex-row justify-between items-end text-xs font-semibold tracking-wider uppercase z-30 md:absolute md:bottom-8 mt-4 md:mt-0 pb-6 md:pb-0">
        <motion.div 
        ...
        >
          <span className="text-xl sm:text-2xl font-black">©2026</span>
          <span className="text-[#666] mt-0.5 sm:mt-1 block max-w-[200px]">building since 2022</span>
          
          <Link 
            href="/atom-se" 
            className="bg-white hover:bg-neutral-100 active:scale-95 text-black px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-md shadow-xs border border-neutral-200 mt-2 sm:mt-3 inline-flex items-center gap-2 w-max transition-all cursor-pointer text-[11px] sm:text-xs"
          >
        ...
        >
          ...
          <motion.div
            ...
            className="mb-1 sm:mb-2 relative p-[2px] rounded-full overflow-hidden"
          >
            ...
            <a
              ...
              className="relative flex items-center gap-1.5 sm:gap-2 bg-white text-[#111111] hover:scale-[1.02] active:scale-[0.98] transition-all py-2.5 px-4 sm:py-3 sm:px-6 rounded-full font-semibold text-xs sm:text-[14px] shadow-[0_4px_20px_rgba(0,0,0,0.08)] normal-case tracking-normal z-10 w-full h-full"
            >
              <svg viewBox="0 0 24 24" fill="#25D366" className="w-4 h-4 sm:w-5 sm:h-5 shrink-0">
