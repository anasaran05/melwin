...
import { Calendar, type LucideIcon, MapPin, Sparkles, Layers, Cpu, ShieldCheck } from 'lucide-react'
...
export function Features({ className }: FeaturesProps) {
    return (
        <section className={cn("bg-zinc-50 py-16 md:py-24 dark:bg-transparent", className)}>
                    ...
                    <FeatureCard>
                        ...
                        <div className="relative mb-6 border-t border-dashed sm:mb-0">
                            ...
                            <div className="aspect-[76/59] p-1 px-6">
                                <DualModeImage
                                    darkSrc="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80"
                                    lightSrc="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80"
                    ...
                    <FeatureCard>
                        ...
                        <CardContent>
                            <div className="relative mb-6 sm:mb-0">
                                ...
                                <div className="aspect-[76/59] border overflow-hidden rounded-lg">
                                    <DualModeImage
                                        darkSrc="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?auto=format&fit=crop&w=1200&q=80"
                                        lightSrc="https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&w=1200&q=80"
...
export const CardHeading = ({ icon: Icon, title, description }: CardHeadingProps) => (
    <div className="p-6">
        ...
        <p className="mt-8 text-2xl font-semibold tracking-tight">{description}</p>
    </div>
)
...
export const DualModeImage = ({ darkSrc, lightSrc, alt, width, height, className }: DualModeImageProps) => (
    <>
        <img
            src={darkSrc}
...
export const CircularUI = ({ label, circles, className }: CircularUIProps) => (
