...
export function ImageStreamHeroDemo() {
  return (
    <ImageStreamHero
      images={IMAGES}
      className="h-[560px] w-full rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-background"
    >
...
export default ImageStreamHeroDemo
