...
export interface HeroCarouselProps {
  ...
  /** Extra action elements rendered in the top bar. @default undefined */
...
export function HeroCarousel({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-x-0 top-0 flex flex-col justify-end pointer-events-none z-10"
        style={{
        ...
        >
          {items.map((item, i) => (
            <motion.button
              ...
              onClick={() => go(i)}
              className="relative shrink-0 overflow-hidden rounded-none bg-white/5 cursor-pointer"
              style={{ width: cardW }}
